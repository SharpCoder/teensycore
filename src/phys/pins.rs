...
#[macro_export]
/**
 This macro will read a gpio pin in 5 clock cycles.
 It's very fast, although the emitted assembly looks
 like a mess.
*/
macro_rules! pin_read_fast {
    ($pin:expr) => {
        match $pin {
            0 => read_word(addrs::GPIO6) & (0x1 << 3),
            1 => read_word(addrs::GPIO6) & (0x1 << 2),
            2 => read_word(addrs::GPIO9) & (0x1 << 4),
            3 => read_word(addrs::GPIO9) & (0x1 << 5),
            4 => read_word(addrs::GPIO9) & (0x1 << 6),
            5 => read_word(addrs::GPIO9) & (0x1 << 8),
            6 => read_word(addrs::GPIO7) & (0x1 << 10),
            7 => read_word(addrs::GPIO7) & (0x1 << 17),
            8 => read_word(addrs::GPIO7) & (0x1 << 16),
            9 => read_word(addrs::GPIO7) & (0x1 << 11),
            10 => read_word(addrs::GPIO7) & (0x1 << 0),
            11 => read_word(addrs::GPIO7) & (0x1 << 2),
            12 => read_word(addrs::GPIO7) & (0x1 << 1),
            13 => read_word(addrs::GPIO7) & (0x1 << 3),
            14 => read_word(addrs::GPIO6) & (0x1 << 18),
            15 => read_word(addrs::GPIO6) & (0x1 << 19),
            16 => read_word(addrs::GPIO6) & (0x1 << 23),
            17 => read_word(addrs::GPIO6) & (0x1 << 22),
            18 => read_word(addrs::GPIO6) & (0x1 << 17),
            19 => read_word(addrs::GPIO6) & (0x1 << 16),
            20 => read_word(addrs::GPIO6) & (0x1 << 26),
            21 => read_word(addrs::GPIO6) & (0x1 << 27),
            22 => read_word(addrs::GPIO6) & (0x1 << 24),
            23 => read_word(addrs::GPIO6) & (0x1 << 25),
            24 => read_word(addrs::GPIO6) & (0x1 << 12),
            25 => read_word(addrs::GPIO6) & (0x1 << 13),
            26 => read_word(addrs::GPIO6) & (0x1 << 30),
            27 => read_word(addrs::GPIO6) & (0x1 << 31),
            28 => read_word(addrs::GPIO8) & (0x1 << 18),
            29 => read_word(addrs::GPIO9) & (0x1 << 31),
            30 => read_word(addrs::GPIO8) & (0x1 << 23),
            31 => read_word(addrs::GPIO8) & (0x1 << 22),
            32 => read_word(addrs::GPIO7) & (0x1 << 12),
            33 => read_word(addrs::GPIO9) & (0x1 << 7),
            34 => read_word(addrs::GPIO8) & (0x1 << 15),
            35 => read_word(addrs::GPIO8) & (0x1 << 14),
            36 => read_word(addrs::GPIO8) & (0x1 << 13),
            37 => read_word(addrs::GPIO8) & (0x1 << 12),
            38 => read_word(addrs::GPIO8) & (0x1 << 17),
            39 => read_word(addrs::GPIO8) & (0x1 << 16),
            _ => 1337,
        }
    };
}
